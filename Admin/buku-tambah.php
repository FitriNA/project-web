...
<form action="buku-tambah-proses.php" method="post">
  <table width="429" border="0" cellspacing="0" cellpadding="3" align="left">
    ...
    <tr>
      <td>Jenis</td>
      <td><div align="center">:</div></td>
      <td><input name="jenis" type="text" class="form-control" id="judul" style="border: 1px solid #24890d;" required/></td>
    </tr>
    <tr>
      <td>ISBN</td>
      <td><div align="center">:</div></td>
    ...
    <tr>
      <td>Penulis</td>
      <td><div align="center">:</div></td>
      <td><input name="penulis" type="text" class="form-control" id="penulis" style="border: 1px solid #24890d;" required/></td>
    </tr>
    <tr>
      <td>Penerbit</td>
      <td><div align="center">:</div></td>
      <td><input name="penerbit" type="text" class="form-control" id="penerbit" style="border: 1px solid #24890d;" required/></td>
    </tr>
    <tr>
      <td>Tahun Terbit</td>
      <td><div align="center">:</div></td>
